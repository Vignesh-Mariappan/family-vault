...
const DefaultCategories = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-wrap gap-4 m-4">
        ...
        {
            label: 'Personal',
            icon: <FaIdCard size={40} className="text-white drop-shadow" />,
            route: 'personal',
        ...
        {
            label: 'Educational',
            icon: <FaGraduationCap size={40} className="text-white drop-shadow" />,
            route: 'educational',
        ...
        {
            label: 'Professional',
            icon: <FaBriefcase size={40} className="text-white drop-shadow" />,
            route: 'professional',
        ...
        {
            label: 'Health',
            icon: <FaHeart size={40} className="text-white drop-shadow" />,
            route: 'health',
        ...
        {
            label: 'Investments',
            icon: <FaWallet size={40} className="text-white drop-shadow" />,
            route: 'investments',
        ...
        {
            label: 'Home',
            icon: <FaHome size={40} className="text-white drop-shadow" />,
            route: 'home',
